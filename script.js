...
// Анимация для карточек программы при скролле
const programCards = document.querySelectorAll('.step-card, .program-final');
...
// Добавьте эту строку в массив openButtons для модального окна
const openButtons = document.querySelectorAll('.btn-challenge, .btn-large, .program-final .final-benefits span');